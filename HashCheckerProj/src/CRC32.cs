...
public class CRC32 : HashAlgorithm
{
    ...
    //[CLSCompliant(false)]
    internal CRC32(uint polynomial)
    {
        HashSizeValue = 32;
    ...
    //[CLSCompliant(false)]
    internal static readonly uint DefaultPolynomial = 0xEDB88320; // Bitwise reflection of 0x04C11DB7;
    #endregion
    ...
    private void reverse(ref byte[] arr)
    {
        int n = arr.Length;
        byte t;
        if (n > 0)
